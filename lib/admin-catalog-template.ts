...
> = {
  ...
  personnel: {
    ...
    widths: [28, 34, 22, 18, 24, 28, 20, 30, 30, 18],
    instructions: [
      ...
      [
        "Quyền nhập lịch",
        "Có",
        "Nhập Có hoặc Không. Đây là quyền bổ sung, chỉ áp dụng cho Chuyên viên, Giảng viên hoặc Trợ giảng; không phải một vai trò",
      ],
      [
        "Loại phòng",
        "Có",
