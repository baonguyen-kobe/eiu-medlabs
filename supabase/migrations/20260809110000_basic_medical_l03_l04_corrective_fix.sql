...
-- Corrective fix for YC-L03 email subject format and YC-L03/YC-L04 backend separation.

-- 1. Fix YC-L03 exact subject format in public.reschedule_class
...
-- 2. Restrict update_class_schedule_details to YC-L04 authorized actors (Admin/scoped Staff) for Basic Medical schedules
...
begin
  ...
  if not can_manage_details then
    -- Basic Medical schedule full edit (YC-L04) requires Admin or scoped Staff. Lecturers are denied via update_class_schedule_details.
