...
| BASE-01  | Authenticated protected-screen rendered baseline                        | 0     | P0       | DONE | Local Supabase and approved local administrator | Representative protected routes at required viewports | Local admin session proved shell, protected rendering, representative data surfaces, and no page overflow at 375/768/1024/1440 for dashboard, classes, shifts, equipment requests, Basic Medical registrations/equipment, and personnel. No production dependency or auth bypass. Manual user review deferred by explicit authorization for MEGA RUN A v2 |
...
| A11Y-02  | Consolidate overlay focus, Escape, inert, and focus-return behavior     | 2     | P1       | IN_PROGRESS | AUTH-01; BASE-01 where protected                           | Shared overlay foundation plus five child families        | Foundation commit `ff6e06f` is verified. Family rollout remains in progress: A11Y-02.1 is DONE; A11Y-02.2–A11Y-02.5 remain. Manual user review deferred by explicit authorization for MEGA RUN A v2 |
...
| ID        | Task                                            | Phase | Priority | Status  | Dependencies     | Scope                     | Verification/Evidence                                          |
| --------- | ----------------------------------------------- | ----- | -------- | ------- | ---------------- | ------------------------- | -------------------------------------------------------------- |
| A11Y-02.1 | Mobile WorkspaceShell/sidebar focus contract    | 2     | P1       | DONE | A11Y-02; BASE-01 | Mobile navigation         | Commit `86e89fa`. Sidebar uses shared focus foundation: close-button entry, Tab/Shift+Tab containment, Escape/focus return, body lock, and existing backdrop close. Verified 375 |
| A11Y-02.2 | Personnel drawer focus contract                 | 2–4   | P1       | DONE | A11Y-02; BASE-01 | Personnel edit drawer     | Commit `0884d75`. Exact opener return, close-button entry, Tab/Shift+Tab containment, Escape/pending-safe close, nested ConfirmDialog topmost handling, and body lock verified at 375. Manual user review deferred by explicit authorization for MEGA RUN A v2 |
