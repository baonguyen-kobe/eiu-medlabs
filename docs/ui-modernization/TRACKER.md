...
| A11Y-02  | Consolidate overlay focus, Escape, inert, and focus-return behavior     | 2     | P1       | READY | AUTH-01; BASE-01 where protected                           | Shared overlay foundation plus five child families        | ConfirmDialog is accepted behavior reference |
